...
(function () {
    ...
    ss.type = "text/css";
    ss.rel = "stylesheet";
    ss.href = `${window.$newbooks.css_url}`;
...
function createbooklist() {
    ...
    var endpoint = `${window.$newbooks.api_endpoint}` + window.$newbooks.activationdate;
                ...
                if (response[i].publicationdate >= window.$newbooks.min_publication_date) {
                    if (response[i].booktype == window.$newbooks.booktype || window.$newbooks.booktype == "all") {
                        template +=
                            `<div class="bookitem">
                                <div class="bookcover">`
                                if (response[i].coverurl && response[i].coverurl != `${window.$newbooks.nocoverurl}`) {
...
function carousel_load() {
    jQuery.ajax({
        url: `${window.$newbooks.bookshelf_url}` ,
        dataType: 'script',
        cache: true,
        success: function() {
